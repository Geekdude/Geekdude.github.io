...
Matrix.Rotate = function (axis, angle)
{
   if (axis.elements.length == 3) {
      var c = Math.cos(angle);
      var s = Math.sin(angle);
      var t = 1 - c;
      var x = axis.elements[0];
      var y = axis.elements[1];
      var z = axis.elements[2];
      var tx = t*x;
      var ty = t*y;

      var r = Matrix.I(4);
      r.elements[0][0] = tx * x + c;
      r.elements[0][1] = tx * y - s * z;
      r.elements[0][2] = tx * z + s * y;

      r.elements[1][0] = tx * y + s * z;
      r.elements[1][1] = ty * y + c;
      r.elements[1][2] = ty * z - s * x;

      r.elements[2][0] = tx * z - s * y;
      r.elements[2][1] = ty * z + s * x;
